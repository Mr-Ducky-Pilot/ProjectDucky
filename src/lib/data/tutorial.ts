...
/**
 * A hand-picked 15-stop tour across all 6 levels: single-board, no
 ...
 *
 * 35-pet-namer (L3) is placed before 41-pet-greeting-routine (L4) on
 * purpose — the greeting routine reads $pet.name, so naming the duck
 * first avoids an empty-name greeting.
 */
export const TUTORIAL_STOPS: TutorialStop[] = [
	{ level: 0, id: '01-ducky-says-hi' },
	{ level: 0, id: '06-hide-and-peek' },
	{ level: 0, id: '04-shake-to-wake' },
	{ level: 0, id: '08-touch-logo' },
	{ level: 0, id: '09-compass-quest' },
	{ level: 1, id: '13-welcome-jingle' },
	{ level: 1, id: '14-light-theremin' },
	{ level: 1, id: '17-dice-roller' },
	{ level: 2, id: '24-button-race' },
	{ level: 2, id: '35-magic-8-ball' },
	{ level: 2, id: '37-breath-buddy' },
	{ level: 3, id: '35-pet-namer' },
	{ level: 3, id: '36-pet-palette' },
