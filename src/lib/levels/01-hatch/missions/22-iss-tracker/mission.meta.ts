...
const meta: MissionMeta = {
	...
	story: 'The International Space Station orbits Earth every 90 minutes at 27,600 km/h — faster than a bullet. Right now there are astronauts up there! Your Ducky tracks where the ISS is at this very moment.',
