...
const meta: MissionMeta = {
	...
	story: 'Every commercial airliner broadcasts its position every second using ADS-B radio. Ducky listens in and paints a live radar showing all the real planes near a chosen airport — on screen and on the OLED display.',
